...
class AdminController extends Controller {
	...
	public function savePayments(Request $request) {
		...
		$sql->enable_bank_transfer = $request->enable_bank_transfer;

		$sql->bank_swift_code = $request->bank_swift_code;
		$sql->account_number = $request->account_number;
		$sql->branch_name = $request->branch_name;
		$sql->branch_address = $request->branch_address;
		$sql->account_name = $request->account_name;
		$sql->iban = $request->iban;
